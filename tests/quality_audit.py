...
def main() -> int:
    ...
    test_evidence = {
        ...
        "facts": [
            "The functional mapping contains 46 executable Qt test cases and the specification contains 11 quality cases.",
    ...
    completion = {
        ...
        "facts": [
            ...
            "The regular unit run and QT_SCALE_FACTOR=1 run each report 70 passed, 0 failed, and 0 skipped.",
    ...
    code_quality = {
        ...
        "criteria": [
            ...
            },
            {
                ...
                "atomic_checks": [
                    {"id": "CQ-TEST-01-A", "result": specification.get("case_count") == 57 and not specification.get("validation_errors"), "evidence": "test_specification.json"},
                    {"id": "CQ-TEST-01-B", "result": len(unit.get("cases", [])) == 46, "evidence": "unit.json"},
