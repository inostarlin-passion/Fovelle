...
FUNCTIONAL_CASES = (
    ...
    case("TC-APP-VERSION", "应用版本与构建版本一致", "验证发布版本契约。", "CMake/qmake 版本定义可读；应用已初始化。", "读取 VERSION/VERSION_STRING 和运行时版本。", "执行 FeatureTests::testApplicationVersionIsCurrent。", "所有版本来源为 0.1.4 且一致。", "不修改版本配置。", "unit", "tests/tst_qviewtests.cpp::FeatureTests::testApplicationVersionIsCurrent", ("unit.json", "static.json")),
