...
CASES = [
    ...
    make_case(
        ...
        ["Qt Linguist lupdate 可执行。", "四个 TS 文件可读。"],
        {"contexts": ["QVOptionsDialog"], "scope": "General", "explicit_entries": ["Appearance:", "Show small images at 1:1", "Associate all supported formats", "Use checkerboard background", "Open images in the same window", "Smooth scaling:", "Auto update check:"]},
